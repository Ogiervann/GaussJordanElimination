...
void switchBlockLines(int i, int j, int n, int m, int k, int l, double *a, double* b, double* block1, double* block2){
  int t;
  if(i == j){
    return;
  }
  for(t = 0; t < k+1; t++){
    get_block(i, t, n, m, k, l, a, block1);
    get_block(j, t, n, m, k, l, a, block2);
    put_block(i, t, n, m, k, l, a, block2);
    put_block(j, t, n, m, k, l, a, block1);
  }
...
void switchBlockColumns(int i, int j, int n, int m, int k, int l, double *a, int *pos, double* block1, double* block2){
  int t;
  if(i == j){
    return;
  }
  for(t = 0; t < k+1; t++){
    get_block(t, i, n, m, k, l, a, block1);
    get_block(t, j, n, m, k, l, a, block2);
    put_block(t, i, n, m, k, l, a, block2);
    put_block(t, j, n, m, k, l, a, block1);
  }
